...
# @time pure_numerical_no_interpolation = Bellman_numerical(s_range 					= 0.00:2.00,
#                 sprime_range 				= 0.00:2.00,
#                 consumption_range 			= 0.00:10.00,
#                 labor_range 					= 0.00:10.00,
#                 value_function_nextperiod 	= zeros(3))
# 
# # keys(pure_numerical_no_interpolation)
# error_pure_numerical_no_interpolation = mean(pure_numerical_no_interpolation.budget_balance)
...
Plots.plot(s_range_2,
            pure_numerical_no_interpolation[:optimal_choices][1,:,"c"],
            label = "Period: 1",
...
for t in 1:T
    Plots.plot!(s_range_2,
                pure_numerical_no_interpolation[:optimal_choices][t,:,"c"],
                label = "Period: $t")
end

@timed Plots.plot!(xaxis = "Initial savings",
            yaxis = "Optimal consumption",
            title = "Pure numerical solution", legend = false)