...
approximation_FOC_2_no_interpolation = @timed let 
    approximation_FOC_2_no_interpolation = backwards_FOC_approximation_1(s_range = s_range_2,
...
approximation_FOC_2_no_interpolation = performance_metrics(approximation_FOC_2_no_interpolation)
