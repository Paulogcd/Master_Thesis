...
run(`mv working_elements/Tractable_model_1.html website/resources/Framework_model_1.html`)
run(`mv working_elements/Tractable_model_2.html website/resources/Framework_model_2.html`)
