...
[link to underlying assumptions]
...
[More about the Ordered Multinomial Logit Model]
...
[More about the Logit Model]

## Alternative regression: Health Proxy regression

In the submitted version of my work, I define the health proxy $HP$, and use its estimate,
which leads to: 
...
\begin{equation}\tag{2.4}
  \widehat{H_{i,t}} = \Lambda_{0} \left( \widehat{\beta_0} +
    \widehat{\beta_{H}} \cdot Health_{i,t} +
    \widehat{\beta_{HP}} \cdot \widehat{HP}_{i,t}^{I} \right)
\end{equation}
