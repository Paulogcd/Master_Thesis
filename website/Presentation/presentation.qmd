...
::: {.column width="100%"}
![Consumption policy comparison accross scenarios.](resources/comparison_Labor.png){width=90%}
:::
...
::: {.column width="100%"}
![Consumption policy comparison accross scenarios.](resources/comparison_Savings.png){width=90%}
:::
