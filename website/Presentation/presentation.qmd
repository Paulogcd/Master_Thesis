...
![Average health in different temperature scenarios.](resources/average_health.png){width=90%}
...
::: {.column width="100%"}
![Consumption policy comparison accross scenarios.](resources/comparison_Consumption.png){width=90%}
:::
...
::: {.column width="100%"}
![Labor Supply policy comparison accross scenarios.](resources/comparison_Labor.png){width=90%}
:::
...
::: {.column width="100%"}
![Savings policy comparison accross scenarios.](resources/comparison_Savings.png){width=90%}
:::
